...
export const metadata: Metadata = {
  ...
  description:
    "Create beautiful, customizable QR codes for free with AI. 27+ types including URL, WiFi, vCard, WhatsApp, Instagram, Email, Bitcoin. Custom patterns, colors, gradients, logos, frames. No sign-up required.",
  keywords: [
  ...
  authors: [{ name: "Live QR Code" }],
  creator: "Live QR Code",
  publisher: "Live QR Code",
  metadataBase: new URL("https://liveqrcode.com"),
  alternates: {
    canonical: "/",
  },
  robots: {
  ...
  openGraph: {
    ...
    title: "Live QR Code - Free AI QR Code Generator",
    description: "Create stunning QR codes with custom patterns, gradients, logos, and AI art. 100% free, no sign-up required.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Live QR Code - Free AI QR Code Generator",
    description: "Create stunning QR codes with custom patterns, gradients, logos, and AI art. 100% free.",
  },
  verification: {},
  category: "Technology",
};
